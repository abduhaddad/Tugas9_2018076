...
import com.example.a2018076_tugas4.databinding.ActivityManageProductBinding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(ManageProduct.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    binding.edtname.setText("");
                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(ManageProduct.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ManageProduct.this, DisplayItem.class));
            }
        });
//for storing new data or update data
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(ManageProduct.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(ManageProduct.this, DisplayItem.class);
                    startActivity(a);
                }
            }
        });
